...
struct Book books[100]={
	{1,"Mat biec","Nguyen nhat anh", 1014, 44, 1, 12, 1999},
	{2,"De men","To hoai", 1001, 99, 15, 8, 1941},
	{3,"Lao hac","Nam cao", 2001, 39, 20, 5, 1943},	
};
int n=3;
...
//quan li khach hang
	...
	int luachon;
	do{
		prinMenuCostum();//in menu quan li khach hang
		printf("\n\tYour Choice: ");
		scanf("%d", &luachon);
		...
		switch(luachon){
			case 1:
				printListCostum(costums, a);//in danh sach khach hang
				exitProgram(&select);//exit hoac back
				break;
			case 2:
				addCostum(costums, &a);
				exitProgram(&select);
